...
from .views import (
    AdminCheckView, AdminLoginView, AdminLogoutView, BrewBatchView, CategoryViewSet,
    CoffeePresetViewSet, CsrfView, HealthView, ItemSetStockView, ItemSettleView, ItemViewSet,
